...
def subparser(subparsers):
    subparser = subparsers.add_parser('locuspocus')
    ...
    subparser.add_argument(
        '-t', '--type', metavar='TYPE', help='apply locus parsing to features '
        'of type TYPE; by default, parsing is applied to all top-level '
        'features regardless of type'
    )
    subparser.add_argument(
...
def main(args):
    ...
    locusstream = tag.locus.pocus(
        *instreams, featuretype=args.type, minbp=args.min_bp,
